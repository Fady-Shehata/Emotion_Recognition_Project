...
class Series extends StatefulWidget {
  ...
  //Series({Key? key, required String Emotion  }) : super(key: key); //, required String recommendationType
...
{
      var data = await _firestore.collection(emotion).doc("Series").collection("Information").get();
...
class Series extends StatefulWidget {
  ...
  //Series({Key? key, required   }) : super(key: key);  required String recommendationType
  final String? Emotions;
  const Series(this.Emotions);
  @override
  State<Series> createState() => _SeriesState();
}
...
void getData () async   
{
      var data = await _firestore.collection("Happy").doc("Series").collection("Information").get();
